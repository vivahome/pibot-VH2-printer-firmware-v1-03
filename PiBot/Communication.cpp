...
#if DRIVE_SYSTEM==3
FSTRINGVALUE(Com::tFirmware,"FIRMWARE_NAME:PiBot-Repetier_" PiBot_FM_VERSION " FIRMWARE_URL: "PiBot_Firmware_FTP" PROTOCOL_VERSION:1.0 MACHINE_TYPE:PiBot_Delta_"PiBot_HD_VERSION" EXTRUDER_COUNT:" XSTR(NUM_EXTRUDER) " REPETIER_PROTOCOL:2")
#else
#if DRIVE_SYSTEM==0
FSTRINGVALUE(Com::tFirmware,"FIRMWARE_NAME:PiBot-Repetier_" PiBot_FM_VERSION " FIRMWARE_URL: "PiBot_Firmware_FTP" PROTOCOL_VERSION:1.0 MACHINE_TYPE:PiBot_Mendel_"PiBot_HD_VERSION" EXTRUDER_COUNT:" XSTR(NUM_EXTRUDER) " REPETIER_PROTOCOL:2")
#else
FSTRINGVALUE(Com::tFirmware,"FIRMWARE_NAME:PiBot-Repetier_" PiBot_FM_VERSION " FIRMWARE_URL: "PiBot_Firmware_FTP" PROTOCOL_VERSION:1.0 MACHINE_TYPE:PiBot_Core_XY_"PiBot_HD_VERSION" EXTRUDER_COUNT:" XSTR(NUM_EXTRUDER) " REPETIER_PROTOCOL:2")
#endif
#endif
////////////*************
#if PiBot_ESN 
FSTRINGVALUE(Com::tPISFESN,PiBot_SF_ESN)  
FSTRINGVALUE(Com::tPIHDESN,PiBot_HD_ESN) 
#endif
///////////////***************

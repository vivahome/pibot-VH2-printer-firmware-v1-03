...
////******PiBot Predefines*****************************//////////////////////
#if PI_CUSTOMIZE
#include "OnePageConfigure.h"
#endif

/*#define MIN_HARDWARE_ENDSTOP_X true      ///***X min endstop switch
#define MIN_HARDWARE_ENDSTOP_Y true      ///***Y min endstop switch     
#define MIN_HARDWARE_ENDSTOP_Z true      ///***Z min endstop switch
#define MAX_HARDWARE_ENDSTOP_X false     ///***X max endstop switch  
#define MAX_HARDWARE_ENDSTOP_Y false     ///***Y max endstop switch 
#define MAX_HARDWARE_ENDSTOP_Z false    ///***Z max endstop switch */
...
///////////**********function of Power on data recover, (n>0):Power on data recover to firmware upload; 0:normal style 
#define ConfigPowerOnRecover false
...
*/
#if DELTA
#define DRIVE_SYSTEM 3   ///***PiBotDelta
#else
...
// ##########################################################################################
    ...
    */
        ...
        #define DELTA_DRIVE_TYPE 1
            ...
            #define PULLEY_DIAMETER 16.4 // *** Grund <=> Grund
            // #define PULLEY_DIAMETER 17.15 // *** Mitte Seil <=> Mitte Seil
 ...
 #if !defined(XAXIS_STEPS_PER_MM) || !defined(YAXIS_STEPS_PER_MM) || !defined(ZAXIS_STEPS_PER_MM)
        #if PiBotMachine
	#define XAXIS_STEPS_PER_MM 62.994
        /** \brief Number of steps for a 1mm move in y direction.
        For xy gantry use 2*belt moved!
        Overridden if EEPROM activated.*/
	#define YAXIS_STEPS_PER_MM 62.994
        /** \brief Number of steps for a 1mm move in z direction  Overridden if EEPROM activated.*/
	#define ZAXIS_STEPS_PER_MM 2133.333

		#else
        #define XAXIS_STEPS_PER_MM 64
        /** \brief Number of steps for a 1mm move in y direction.
        For xy gantry use 2*belt moved!
        Overridden if EEPROM activated.*/
...
#ifndef EXT0_STEPS_PER_MM 
#if PiBot
#if PI_PRUSA_I3
#define EXT0_STEPS_PER_MM 602.4682302  //DT_PERFORMANCE  200x16x4.3/27.08052867=602.4682302
#else
#define EXT0_STEPS_PER_MM 120 ///***319.8 //DT_PERFORMANCE
#endif
#else
#define EXT0_STEPS_PER_MM 385 //DT_PERFORMANCE
#endif
#endif
  ...
  ////////////////////////**************************
#if PiBotSemitec
#define EXT0_TEMPSENSOR_TYPE 8   ///***PiBot Semetic GT104-2
#else
#define EXT0_TEMPSENSOR_TYPE 1   ///**data change to fit PiBot 3950 thermistor
#endif
    ...
    //  Overridden if EEPROM activated.
    #define EXT0_MAX_FEEDRATE 30  ////****50
    // Feedrate from halted extruder in mm/s
    //  Overridden if EEPROM activated.
    #define EXT0_MAX_START_FEEDRATE 10   ////***40
    // Acceleration in mm/s^2
    //  Overridden if EEPROM activated.
    ...
    */
    ...
    #define EXT0_PID_P   16   ///***14.52
    /** I-gain. Overridden if EEPROM activated.
    */
    #define EXT0_PID_I   0.92   ///***0.95
    /** Dgain.  Overridden if EEPROM activated.*/
    #define EXT0_PID_D 60     ////****55.48
...
#if PiBot==true
#if PI_PRUSA_I3==true
	#define EXT0_WAIT_RETRACT_TEMP 		180 ///***150
	/** \brief Units (mm/inches) to retract filament when extruder is heating up. Overridden if EEPROM activated. Set to 0 to disable. */
	#define EXT0_WAIT_RETRACT_UNITS 	2.2 ///***0
#else
	#define EXT0_WAIT_RETRACT_TEMP 		186 ///***150
	/** \brief Units (mm/inches) to retract filament when extruder is heating up. Overridden if EEPROM activated. Set to 0 to disable. */
	#define EXT0_WAIT_RETRACT_UNITS 	2.2 ///***0
#endif
#else
	#define EXT0_WAIT_RETRACT_TEMP 		150 ///***150
	/** \brief Units (mm/inches) to retract filament when extruder is heating up. Overridden if EEPROM activated. Set to 0 to disable. */
	#define EXT0_WAIT_RETRACT_UNITS 	0 ///***0
#endif
...
#define EXT1_Y_OFFSET 0
    ...
    // for skeinforge 40 and later, steps to pull the plasic 1 mm inside the extruder, not out.  Overridden if EEPROM activated.
#ifndef EXT1_STEPS_PER_MM 
#if PiBot==true
#if PI_PRUSA_I3==true
	#define EXT1_STEPS_PER_MM 602.4682302  //DT_PERFORMANCE  200x16x4.3/27.08052867=602.4682302
#else
	#define EXT1_STEPS_PER_MM 120 ///***319.8 //DT_PERFORMANCE
#endif
#else
	#define EXT1_STEPS_PER_MM 373 //DT_PERFORMANCE
#endif
#endif
    // What type of sensor is used?
    // 1 is 100k thermistor (Epcos B57560G0107F000 - RepRap-Fab.org and many other)
...
#define EXT1_INVERSE true
    ...
    //  Overridden if EEPROM activated.
    #define EXT1_MAX_FEEDRATE 30    ////***25
    // Feedrate from halted extruder in mm/s
    //  Overridden if EEPROM activated.
    #define EXT1_MAX_START_FEEDRATE 10  ////***12
    // Acceleration in mm/s^2
    //  Overridden if EEPROM activated.
    ...
    */
    ...
    /** P-gain.  Overridden if EEPROM activated. */
    #define EXT1_PID_P   16      ////***24
    /** I-gain.  Overridden if EEPROM activated.
    */
    #define EXT1_PID_I   0.92   ///***0.88
    /** D-gain.  Overridden if EEPROM activated.*/
    #define EXT1_PID_D   60      ///***200
    // maximum time the heater is can be switched on. Max = 255.  Overridden if EEPROM activated.
...
#if PiBot==true
#if PI_PRUSA_I3==true
	#define EXT1_WAIT_RETRACT_TEMP 		180 ///***150
	/** \brief Units (mm/inches) to retract filament when extruder is heating up. Overridden if EEPROM activated. Set to 0 to disable. */
	#define EXT1_WAIT_RETRACT_UNITS 	2.2 ///***0
#else
	#define EXT1_WAIT_RETRACT_TEMP 		186 ///***150
	/** \brief Units (mm/inches) to retract filament when extruder is heating up. Overridden if EEPROM activated. Set to 0 to disable. */
	#define EXT1_WAIT_RETRACT_UNITS 	2.2 ///***0
#endif
#else
	#define EXT1_WAIT_RETRACT_TEMP 		150 ///***150
	/** \brief Units (mm/inches) to retract filament when extruder is heating up. Overridden if EEPROM activated. Set to 0 to disable. */
	#define EXT1_WAIT_RETRACT_UNITS 	0 ///***0
#endif
...
#define EXT2_Y_OFFSET 0 ///***520
	// for skeinforge 40 and later, steps to pull the plasic 1 mm inside the extruder, not out.  Overridden if EEPROM activated.
#if PiBot==true
#if PI_PR_I3==true
#define EXT2_STEPS_PER_MM 602.4682302  //DT_PERFORMANCE  200x16x4.3/27.08052867=602.4682302
#else
#define EXT2_STEPS_PER_MM 120 ///***319.8 //DT_PERFORMANCE
#endif
#else
#define EXT2_STEPS_PER_MM 319.8 //DT_PERFORMANCE
#endif
...
#define EXT2_DIR_PIN E2_DIR_PIN
	// set to false/true for normal / inverse direction
#define EXT2_INVERSE true ///***false
#define EXT2_ENABLE_PIN E2_ENABLE_PIN
	// For Inverting Stepper Enable Pins (Active Low) use 0, Non Inverting (Active High) use 1
#define EXT2_ENABLE_ON true
	// The following speed settings are for skeinforge 40+ where e is the
	// length of filament pulled inside the heater. For repsnap or older
	// skeinforge use higher values.
	//	Overridden if EEPROM activated.
...
#define EXT2_MAX_START_FEEDRATE 40
	// Acceleration in mm/s^2
	//	Overridden if EEPROM activated.
#define EXT2_MAX_ACCELERATION 4000 ///***10000
	/** Type of heat manager for this extruder.
	- 0 = Simply switch on/off if temperature is reached. Works always.
	- 1 = PID Temperature control. Is better but needs good PID values. Defaults are a good start for most extruder.
	- 3 = Dead-time control. PID_P becomes dead-time in seconds.
...
#define EXT2_WATCHPERIOD 1
	...
	The precise values may differ for different nozzle/resistor combination.
	 Overridden if EEPROM activated.
	*/
#define EXT2_PID_INTEGRAL_DRIVE_MAX 230   ////****140->230
	/** \brief lower value for integral part
	wsq
	The I state should converge to the exact heater output needed for the target temperature.
	To prevent a long deviation from the target zone, this value limits the lower value.
	A good start is 30 lower then the optimal value. You need to leave room for cooling.
	 Overridden if EEPROM activated.
	*/
#define EXT2_PID_INTEGRAL_DRIVE_MIN 40    ///****60->40
	/** P-gain. Dead-time if dead-time heat manager selected. Overridden if EEPROM activated. */
#define EXT2_PID_P   16 //24
	/** I-gain. Overridden if EEPROM activated.
	*/
#define EXT2_PID_I   0.92 //0.88
	/** D-gain.  Overridden if EEPROM activated.*/
#define EXT2_PID_D 60 //80
...
#if PiBot==true
#if PI_PRUSA_I3==true
#define EXT2_WAIT_RETRACT_TEMP 		180 ///***150
	/** \brief Units (mm/inches) to retract filament when extruder is heating up. Overridden if EEPROM activated. Set to 0 to disable. */
#define EXT2_WAIT_RETRACT_UNITS 	2.2 ///***0
#else
#define EXT2_WAIT_RETRACT_TEMP 		186 ///***150
	/** \brief Units (mm/inches) to retract filament when extruder is heating up. Overridden if EEPROM activated. Set to 0 to disable. */
#define EXT2_WAIT_RETRACT_UNITS 	2.2 ///***0
#endif
#else
#define EXT2_WAIT_RETRACT_TEMP 		150 ///***150
	/** \brief Units (mm/inches) to retract filament when extruder is heating up. Overridden if EEPROM activated. Set to 0 to disable. */
#define EXT2_WAIT_RETRACT_UNITS 	0 ///***0
#endif
...
#define EXT2_DESELECT_COMMANDS "M117 Cancel Extruder 3"
	/** The extruder cooler is a fan to cool the extruder when it is heating. If you turn the etxruder on, the fan goes on. */
#define EXT2_EXTRUDER_COOLER_PIN  -1
	// #define EXT2_EXTRUDER_COOLER_PIN FAN_PIN ///***5
	/** PWM speed for the cooler fan. 0=off 255=full speed */
...
////////////////////////////////************************************************
    ...
    */
    ...
    #define EXTRUDE_MAXLENGTH 160    ////****100->160
...
//////////////////////////////////////////////*****************************************************
    ...
    */
	...
	///////////////////************data cllection for PIbot senser
#if PiBot==true
#if PiBotSemitec
#define NUM_TEMPS_USERTHERMISTOR0 40       /////////////******40
#define USER_THERMISTORTABLE0 {\ 
	   {4, 5873},{108, 2314},{212, 1930},{316, 1727},{420, 1591},{524, 1488},{628, 1406},{732, 1338},\ 
	   {836, 1278},{940, 1226},{1044, 1179},{1148, 1136},{1252, 1097},{1356, 1060},{1460, 1025},\ 
	   {1564, 992},{1668, 961},{1772, 931},{1876, 901},{1980, 873},{2084, 845},{2188, 818},\
	   {2292, 791},{2396, 764},{2500, 737},{2604, 710},{2708, 683},{2812, 655},{2916, 626},\
	   {3020, 597},{3124, 566},{3228, 534},{3332, 499},{3436, 462},{3540, 421},{3644, 375},\ 
	   {3748, 320},{3852, 251},{3956, 153},{4044, 0}   }	
 #else
  #define NUM_TEMPS_USERTHERMISTOR0 40        /////////////******28->40
  #define USER_THERMISTORTABLE0 {\ 
	   {4, 7507},{108, 2615},{212, 2153},{316, 1913},{420, 1754},{524, 1635},{628, 1540},{732, 1461},\
	   {836, 1393},{940, 1333},{1044, 1280},{1148, 1231},{1252, 1187},{1356, 1145},{1460, 1106},\
	   {1564, 1069},{1668, 1034},{1772, 1000},{1876, 967},{1980, 935},{2084, 904},{2188, 874},{2292, 844},\
	   {2396, 814},{2500, 784},{2604, 754},{2708, 724},{2812, 694},{2916, 662},{3020, 630},{3124, 596},\
	   {3228, 561},{3332, 524},{3436, 483},{3540, 438},{3644, 388},{3748, 329},{3852, 254},{3956, 149},{4040, -1}	}
 #endif  
  #else
 ...
 #define USER_THERMISTORTABLE0  {\
    ...
    */
		///////////////***************
#if PiBotSemitec
#define GENERIC_THERM1_BETA 4230
#else
#if PiBot 
#define Thermistor_Beta 3950
#else
#define GENERIC_THERM1_BETA Thermistor_Beta
#endif
#endif
 ...
 /////***************
#if PiBotSemitec
#define GENERIC_THERM2_BETA 4230
#else
#if PiBot 
#define GENERIC_THERM2_BETA 3950   /////////////*******4267->3950
#else
#define GENERIC_THERM2_BETA Thermistor_Beta
#endif
#endif
...
#define GENERIC_THERM3_R0 1042.7
	////////////////////***********************
#if PiBotSemitec
#define GENERIC_THERM3_BETA 4230
#else
#if PiBot 
#define GENERIC_THERM3_BETA 3950   /////////////*******4267->3950
#else
#define GENERIC_THERM3_BETA Thermistor_Beta
#endif
#endif
...
#if PiBotMachine==true   ////***for pibot 3d printer PLA no heat bed use.
#define HAVE_HEATED_BED true
#else
#define HAVE_HEATED_BED false
#endif
#endif
    #define HEATED_BED_MAX_TEMP 110   ///***115->110
    /** Skip M190 wait, if heated bed is already within x degrees. Fixed numbers only, 0 = off. */
	#if PiBot
		#define SKIP_M190_IF_WITHIN 10    //////*** 3->8 the heat bed with a larger range zone
	#else
...
#if PiBotSemitec
	#define HEATED_BED_SENSOR_TYPE 8    ////////****0->1   NTC 100K resister
#else
#if PiBot
	#define HEATED_BED_SENSOR_TYPE 1      ////****pibot 3950  100K
#else
    ...
    3 = dead time control
    */
    #define HEATED_BED_HEAT_MANAGER 1    ///*****1->3
/** \brief The maximum value, I-gain can contribute to the output.
    The precise values may differ for different nozzle/resistor combination.
     Overridden if EEPROM activated.
    */
...
#if  !defined(INVERT_X_DIR) || !defined(INVERT_Y_DIR)||!defined(INVERT_Z_DIR)
#if PiBotMachine
#if PI_PRUSA_I3==true
...
#if  !defined(X_HOME_DIR) || !defined(Y_HOME_DIR)||!defined(Z_HOME_DIR)
#if PiBot==true
#define X_HOME_DIR -1   ////****1-> -1
#define Y_HOME_DIR -1
#define Z_HOME_DIR -1
#else
#define X_HOME_DIR 1   ////****1-> -1
...
#define ENDSTOP_Z_BACK_MOVE 3 ///***5->3
	
	// For higher precision you can reduce the speed for the second test on the endstop
	// during homing operation. The homing speed is divided by the value. 1 = same speed, 2 = half speed, 3= one of third
...
#define ENDSTOP_Z_RETEST_REDUCTION_FACTOR 3
	...
	// When you have several endstops in one circuit you need to disable it after homing by moving a
	// small amount back. This is also the case with H-belt systems.
#define ENDSTOP_X_BACK_ON_HOME 3  //////***all to 0, I have pretect on mechine 3->2
...
#if !defined(X_MAX_LENGTH)&&!defined(Y_MAX_LENGTH)&&!defined(Z_MAX_LENGTH)
#if PiBot
#if PI_PRUSA_I3==true    //////////////*******PiBot Prusa i3
#define X_MAX_LENGTH 190
#define Y_MAX_LENGTH 190
#define Z_MAX_LENGTH 190
#else 
#define X_MAX_LENGTH 240   ///***PiBot Machine
...
#endif
#ifdef DELTA     /////****PiBot Delta
#define X_MAX_LENGTH 165
#define Y_MAX_LENGTH 175
#define Z_MAX_LENGTH 460
#endif
#endif
...
// ##########################################################################################
    ...
    */
    ...
    // Delta settings
        ...
        */
	/* => this settings are normally not needed to change; this is if you don't match the angles */
        /** \brief column positions - change only to correct build imperfections! */
        #define DELTA_ALPHA_A 210    ///***** Add with 120  angel 90+120 +120
		...
		/* => normally you don't need this settings, its only if your build is really bad */
        ...
        */
        #define END_EFFECTOR_HORIZONTAL_OFFSET 37
...
#if PiBot==true
#if PI_PRUSA_I3==true
#define MAX_FEEDRATE_X 100 ///***300
#define MAX_FEEDRATE_Y 100 ///***300
#define MAX_FEEDRATE_Z 6  ///***300		
		/** Home position speed in mm/s. Overridden if EEPROM activated. */
#define HOMING_FEEDRATE_X 10 ///***80
#define HOMING_FEEDRATE_Y 10 ///***80
#define HOMING_FEEDRATE_Z 1  ///***80
#else
#define MAX_FEEDRATE_X 200 ///***300
...
#define MAX_FEEDRATE_Y 200 ///***300
#define MAX_FEEDRATE_Z 200  ///***300		
		/** Home position speed in mm/s. Overridden if EEPROM activated. */
#define HOMING_FEEDRATE_X 200 ///***80
#define HOMING_FEEDRATE_Y 200 ///***80
#define HOMING_FEEDRATE_Z 200  ///***80
#endif
...
#define HOMING_ORDER HOME_ORDER_XYZ
    ...
    */
    #if PiBot==true
#if PI_PRUSA_I3==true
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_X 1000 ///***1500
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Y 1000 ///***1500
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Z 60   ///***100

/** \brief X, Y, Z max acceleration in mm/s^2 for travel moves.  Overridden if EEPROM activated.*/
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_X 3000
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Y 3000
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Z 60   ///***100
#else
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_X 1200 ///***1500
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Y 1200 ///***1500
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Z 68   ///***100

/** \brief X, Y, Z max acceleration in mm/s^2 for travel moves.  Overridden if EEPROM activated.*/
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_X 3000
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Y 3000
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Z 68  ///***100
#endif
#else
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_X 1500 ///***1500
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Y 1500 ///***1500
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Z 100   ///***100

/** \brief X, Y, Z max acceleration in mm/s^2 for travel moves.  Overridden if EEPROM activated.*/
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_X 3000
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Y 3000
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Z 100  ///***100
#endif
...
////////////////*******with enough driver control pin 
  ...
  /* A watchdog resets the printer, if a signal is not send within predifined time limits. That way we can be sure that the board
	...
	#define Z_PROBE_PIN    PiBot_Z_PROBE_PIN    ////***use Z-min Pin test 64
	#define Z_PROBE_PULLUP false
#if	(!defined(Z_PROBE_X_OFFSET) || !defined(Z_PROBE_Y_OFFSET))
    #define Z_PROBE_X_OFFSET 35       ///*** probing to your endstop  mm  X-35   (not needed very  acurated)
    #define Z_PROBE_Y_OFFSET -14       ///*** probing to your endstop  mm   Y+14   (point senser)
#endif
#else
...
#endif
////////////////**************input signal invert use
    #define Z_PROBE_ON_HIGH true    ///*** true invert read   default is true
 #ifndef Z_PROBE_BED_DISTANCE
    #define Z_PROBE_BED_DISTANCE 10.0 // Higher than max bed level distance error in mm  ///***move down
 #endif
    #define Z_PROBE_SWITCHING_DISTANCE 5 // Distance to safely switch off probe       ///***move up 1->1.5
    ...
    #define Z_PROBE_SPEED 3        ///***OK
    #define Z_PROBE_XY_SPEED 68    ///*** fit PiBot machine (travel speed)  150->68
    #define Z_PROBE_REPETITIONS 3  // Repetitions for probing at one point.   ///***OK  5->3
    /** The vertical offerset of the probing and hotend */
    /** The height is the difference between activated probe position and nozzle height. */
	//////******PiBot not use any sharp tigger, but an PiBot reflect Optical endstop instead.  *****///// 
#ifndef Z_PROBE_HEIGHT
    #define Z_PROBE_HEIGHT 2  //0.3->2    ////****39.91   n * mm/step      eg: 2333.333 step/mm Zaxis -> 39.91*1/2333.333=0.017mm
#endif
    ...
    #define Z_PROBE_START_SCRIPT "M117 probe start"
    #define Z_PROBE_FINISHED_SCRIPT "M117 probe finish"
...
***************************************************************************************/	
	...
	#if !defined(Z_PROBE_X1) || !defined(Z_PROBE_X2) || !defined(Z_PROBE_X3)
    ...
    */
    ...
    #if PiBot    ///****PiBot former Version
	#if PiBot_V_1_0 
    	#define FEATURE_CONTROLLER 9  /////***** Hardware Version before than 1.4
    #else
...
#if PiBotSemitec
	////****pibot semitec 100k GT2 b=4230
#define UI_SET_PRESET_HEATED_BED_TEMP_PLA 60
#define UI_SET_PRESET_EXTRUDER_TEMP_PLA   191  
...
#define UI_SET_PRESET_EXTRUDER_TEMP_PLA   200  ///***180
...
#define UI_SET_EXTRUDER_RETRACT_DISTANCE 3 // mm	
	 ...
	 #define ZAXIS_STEPS_PER_MM DELTA_AXIS_STEPS_PER_MM
#endif

#if NUM_EXTRUDER==2
#define EXT1_X_OFFSET EXT0_EXT1_DistanceX
#define EXT1_Y_OFFSET EXT0_EXT1_DistanceY
#endif

#if HAVE_HEATED_BED==true  ////***if have powful heatbed MOSFET very hot, Controller need a cooling fan
#if EXT1_EXTRUDER_COOLER_PIN!=FAN2_PIN
#define FAN_BOARD_PIN FAN2_PIN
#else
#define FAN_BOARD_PIN -1
#endif
#if PiBotMachine  && NUM_EXTRUDER<3  &&  PiBot_V_2_0==false
#define BED_MOSFET_COOL_PIN  HEATER_3_PIN
#else
#define BED_MOSFET_COOL_PIN -1
#endif
#else
#define BED_MOSFET_COOL_PIN  -1
#endif

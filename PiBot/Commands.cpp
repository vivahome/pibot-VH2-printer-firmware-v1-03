...
*/
    ...
    else if(com->hasM())    // Process M Code
    {
        ...
        case 85: // M85
            ...
            break;
	////////////////////////********************
		case 88: // M88  report hardware ESN
				Com::printFLN(Com::tPISFESN);
				Com::printFLN(Com::tPIHDESN);
		break;
	///////////////////////********************
...
//////////////**********************###############
#if BED_MOSFET_COOL_PIN>-1 
	WRITE(BED_MOSFET_COOL_PIN,HEATER_PINS_INVERTED);
#endif
#endif
    while(1) {}
    END_INTERRUPT_PROTECTED

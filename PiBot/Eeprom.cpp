...
//	uint8_t Config_Power_on_Recover=HAL::eprGetByte(EPR_POWER_ON_BYTE);
	#if (defined (ConfigPowerOnRecover) && ConfigPowerOnRecover==true)	    
	    { 
	        readDataFromEEPROM();
	    }
	#else
	    ...
	    {
//	        HAL::eprSetBool(EPR_POWER_ON_BYTE,ConfigPowerOnRecover);

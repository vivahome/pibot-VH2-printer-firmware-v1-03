...
#define PiBot_HD_ESN "PI_PBHD0002_0"
#define PiBot_HD_VERSION "Rev2.0"
///////////////********define for temperature senser chip  connection
///****Not design the ISP port in Rev 2.0 for max6675      
//  #define MAX6675_TEMP_Senser false 
#define AD595_TEMP_Senser false    /////*** you can input at port 59 60 61 ///Analoge Pin 8  9 10
#endif

#if MOTHERBOARD == 315
#define MOTHERBOARD 314
// #define PiBot_V_1_4 true
// #define PiBot_HD_ESN "PI_PBHD0001_4"
#define PiBot_V_1_6 true
#define PiBot_HD_ESN "PI_PBHD0001_6"
#define PiBot_HD_VERSION "V1.6"
//#define PiBot_Taiwan false
//#define PiBot_TaiwanE2 false
#endif
...
#define PiBot_ESN  true //////define ESN
#define PiBot_SF_ESN "PI_3014009898"   ////***** "PI_3.14009898   12 byte
...
#define TEMP_2_PIN         4     // ANALOG NUMBERING   ////*** Extuder2
#endif
#define TEMP_3_PIN         -1    /////***for Pibot  // ANALOG NUMBERING   ////***Extuder3
#define TEMP_4_PIN         -1    /////***for Pibot  // ANALOG NUMBERING   ////***Extuder3
...
#define HEATER_PINS_INVERTED 0    ////***use for heater signal invert
#endif
...
#define SENSITIVE_PINS {0, 1, X_STEP_PIN, X_DIR_PIN, X_ENABLE_PIN, X_MIN_PIN, X_MAX_PIN, \
	    Y_STEP_PIN, Y_DIR_PIN, Y_ENABLE_PIN, Y_MIN_PIN, Y_MAX_PIN, Z_STEP_PIN, Z_DIR_PIN, \
	    Z_ENABLE_PIN, Z_MIN_PIN, Z_MAX_PIN, LED_PIN, PS_ON_PIN, HEATER_0_PIN, HEATER_1_PIN,\
	    FAN_PIN, E0_PINS E1_PINS E2_PINS TEMP_0_PIN, TEMP_1_PIN,SDSS }
#endif///*** end pibot three extruder sensitive pins define 
